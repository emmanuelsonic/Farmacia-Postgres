    ...
    switch ($Bandera) {
        ...
        case 1:
			...
			<td width="275" align="center"><strong>Eliminar</strong></td>
                        ...
                        $Especialidad = "" . $Origen . "" . strtoupper($Datos["NombreSubServicio"]) . "";
                        ...
                        echo $Fecha . "~" . $tabla . "~" . $NombreArea . "~" . $NombreMedico . "~" . $Especialidad . "~" . $IdHistorialClinico . "~" . $NombreFarmacia . "~" . $NombreAreaOrigen . "~" . $IdReceta . "~" . $IdNumeroExp;
...
//REPETITIVAS
		...
		<td width="275" align="center"><strong>Eliminar</strong></td>
                ...
                while ($row = mysql_fetch_array($resp)) {
                    ...
                    $tabla = $tabla . '<tr class="FONDO"><td align="center"><a style="color:red;" onclick="javascript:VentanaBusqueda4(\'ModificaCantidad.php?IdMedicinaRecetada=' . $row["IdMedicinaRecetada"] . '\')">' . $CantidadIntro . '</a></td><td align="center">' . $row["Nombre"] . ', ' . htmlentities($row["Concentracion"] . ' - ' . $row["FormaFarmaceutica"]) . ' - ' . $row["Presentacion"] . '</td><td align="center"><a style="color:blue;" onclick="javascript:VentanaBusqueda4(\'ModificaDosis.php?IdMedicinaRecetada=' . $row["IdMedicinaRecetada"] . '\')">' . $row["Dosis"] . '</a></td><td align="center">' . $check . '</td><td align="center"><input type="button" id="BorrarMedicamento" name="BorrarMedicamento" value="Eliminar Medicamento" onclick="javascript:EliminaMedicina(' . $row["IdMedicinaRecetada"] . ')"></td></tr>';
                }//while resp
                $tabla = $tabla . '</table>';
            } else {
                $tabla = ' ';
...
//REPETITIVAS
        ...
        case 13:
            ...
            if ($Codigo != '') {
                echo $resp["IdSubServicio"] . "/" . $NombreSubEspecialidad;
            } else {
        ...
        case 14:
            ...
            if (isset($_GET["IdSubEspecialidad"])) {
                ...
                if ($IdHistorialClinico == '' or $IdHistorialClinico == NULL) {
                    ...
                    $salida = $proceso->ActualizarEspecialidad($IdHistorialClinico, $IdSubEspecialidad,$IdEstablecimiento,$IdModalidad);
                }
	   ...
	   <input type="button" id="Cambiar2" name="Cambiar2" value="Corregir" onClick="CorregirEspecialidad();">
        ...
        case 18:
            ...
            $IdHistorialClinico = $_GET["IdHistorialClinico"];
            echo $proceso->CambiarExpediente($IdNumeroExp, $IdHistorialClinico, $IdEstablecimiento,$IdModalidad);
            break;
    }//Fin de switch
