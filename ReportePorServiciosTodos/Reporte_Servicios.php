...
//     GENERACION DE EXCEL
        $NombreExcel = 'Servicios_Todos_' . $nick . '_' . date('d_m_Y__h_i_s A');
...
//******************************* QUERIES Y RECORRIDOS
        ...
        if ($rowServicios = mysql_fetch_array($respServicios)) {
			...
			<tr class="MYTABLE">
				...
				<strong>CONSUMO DE MEDICAMENTOS POR SERVICIOS Y CONSULTAS</strong> <br>
      ...
      <td align="right"><strong>' . number_format($SubTotal, 3, '.', ',') . '</strong></td>
                    ...
                    $reporte.='<tr class="FONDO2" style="background:#CCCCCC;">
      <td colspan="4" align="right"><em><strong> Total de ' . htmlentities($NombreSubEspecialidad) . ':</strong></em></td>
