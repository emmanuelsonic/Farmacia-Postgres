...
$sqlStr=$Classquery->ObtenerQuery($Bandera,$IdArea,$q,$IdEstablecimiento);
$sqlStrAux=$Classquery->ObtenerQueryTotal($Bandera,$IdArea,$q,$IdEstablecimiento);
}else{
$Bandera=0;
$sqlStr=$Classquery->ObtenerQuery($Bandera,$IdArea,"",$IdEstablecimiento);
$sqlStrAux=$Classquery->ObtenerQueryTotal($Bandera,$IdArea,"",$IdEstablecimiento);
}
