...
function generaSelect2($IdEstablecimiento,$IdModalidad){//creacioon de combo para las Regiones
	conexion::conectar();
	if($_SESSION["TipoFarmacia"]==1){$comp=" and mfxe.HabilitadoFarmacia='S'";}else{$comp="";}
	$consulta=mysql_query("select distinct mfxe.IdFarmacia,Farmacia
...
<head>
<?php head();?>
<title> Reporte: Consumo de Servicio </title>
...
<center>
  <table width="816" border="0">
    <tr class="MYTABLE">
      <td colspan="5" align="center"><strong>CONSUMO DE MEDICAMENTOS SERVICIO</strong><strong></strong><strong> </strong></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="673" colspan="4" class="FONDO">BIENESTAR MAGISTERIAL</td>
    </tr>
    <tr>
      <td width="280" class="FONDO"><strong>Expediente [Opcional]: </strong></td>
      <td width="673" colspan="4" class="FONDO"><input type="text" id="Expediente" name="Expediente" size="10" onkeypress="return NumeroExpediente(event);"></td>
    </tr>
    <tr>
    ...
    <tr>
      ...
      <td width="673" colspan="4" class="FONDO"><div id="ComboTerapeutico"><select name="IdTerapeutico" id="IdTerapeutico" onChange=" CargarCombo(this.id,this.value);">
        <option value="0">[Consumo General ...]</option>
    ...
    <tr class="MYTABLE">
      <td colspan="5" align="right"><input type="button" id="generar" name="generar" value="Generar Reporte" 
                                           style="border-bottom-color:#000099; border-left-color:#000099; 
                                                  border-top-color:#000099; border-right-color:#000099" 
                                           onClick="javascript:Valida();"></td>
    </tr>
    <!-- <tr class="MYTABLE">
