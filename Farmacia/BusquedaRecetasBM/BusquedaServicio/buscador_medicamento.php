...
<td align=\"left\"><a href=\"#\" onclick=\"javascript:UbicarSubServicio(".$row['IdSubServicio'].",'".htmlentities($row['CodigoFarmacia'])."')\">".$Ubicacion."".htmlentities($row['NombreSubServicio'])."</a></td>
</tr>";
	}//if
