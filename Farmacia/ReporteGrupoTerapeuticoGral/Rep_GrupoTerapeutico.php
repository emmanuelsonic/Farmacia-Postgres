...
//******Generacion del combo principal
        ...
        function generaSelect2() { //creacioon de combo para las Regiones
            ...
            if ($_SESSION["TipoFarmacia"] == 1) {
                $comp = " and mfxe.HabilitadoFarmacia='S'";
            } else {
                $comp = "";
            }
            $consulta = mysql_query("select * 
                                    ...
                                    where mfxe.IdEstablecimiento=".$_SESSION["IdEstablecimiento"]."
                                    and mfxe.IdModalidad=".$_SESSION["IdModalidad"]."
                                    " . $comp);
        ...
        <?php Menu(); ?>
                ...
                <form action="Reporte_GrupoTerapeutico.php" method="post" name="formulario" onSubmit="valida(this);return false;">
                    <table width="816" border="0">
                        <tr class="MYTABLE">
                            <td colspan="5" align="center"><strong>CONSUMO DE MEDICAMENTOS POR AREAS</strong></td>
                        </tr>
