        ...
        <table width="1005">
            <tr><td height="95" align="center">
                    ...
                    <table class="MYTABLE" width="995" style="color:#000000">
                        <tr class="FONDO"><td colspan="4" align="center"><strong>RECETA No:&nbsp;&nbsp;<?php echo $NumeroReceta; ?>,&nbsp;Fecha de Entrega:&nbsp;<?php echo $FechaDeEntrega; ?></strong></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td colspan="3"><div align="right"><span class="FONDO">
                                        <?php if ($Estado == 'R') { ?>
                                            ...
                                            <input type="button" name="<?php echo "verificar" . $IdHistorialClinico; ?>" value="VERIFICAR RECETA" onclick="LoadRecetas(<?php echo $IdArea; ?>,<?php echo $IdPersonal; ?>)" />
                                        <?php
                                        }
                                        if ($Estado == "P") {
                                            ...
                                            if ($par == 0) {
                                                ?>background-color:#00FF00; border:#00FF00<?php } else { ?>background-color:#FF9900; border:#FF9900<?php } ?>" value="<?php echo"$NumeroReceta &nbsp;&nbsp;&nbsp;"; ?>....:::: EN PROCESO ::::.... por: <?php echo $NombreTecnico; ?>" readonly="true" name="<?php echo"verde" . $IdHistorialClinico; ?>" id="<?php echo"verde" . $IdHistorialClinico; ?>" type="text" size="65"/>

                                            <input type="button" id="<?php echo"listo" . $IdHistorialClinico; ?>" name="<?php echo"listo" . $IdHistorialClinico; ?>"  value="LISTO" onclick="javascript:Listo(<?php echo $IdReceta; ?>,<?php echo $NumeroReceta; ?>);" />

                                            <input type="button" name="<?php echo "imprimir" . $IdHistorialClinico; ?>" value="IMPRIMIR" onclick="javascript:popUp('impresion.php?IH=<?php echo $IdHistorialClinico; ?>&IR=<?php echo $IdReceta; ?>&F=<?php echo $fechacon; ?>&IdArea=<?php echo $IdArea; ?>');"/>
