...
function Servicios($IdSubEspecialidad, $IdTerapeutico, $IdMedicina, $FechaInicio, $FechaFin, $IdEmpleado, $IdFarmacia, $IdEstablecimiento, $IdModalidad) {
    ...
    if ($IdEmpleado != '0') {
        $comp3 = "and shc.IdEmpleado='$IdEmpleado'";
    } else {
        $comp3 = "";
    }
    if ($IdFarmacia != '0') {
        $comp4 = "and fr.IdFarmacia='$IdFarmacia'";
    } else {
        $comp4 = "";
    }
    if ($IdSubEspecialidad) {
        $comp5 = " and shc.IdSubServicioxEstablecimiento=" . $IdSubEspecialidad;
    } else {
        $comp5 = "";
    }
...
function NombreTera($grupoTerapeutico, $IdSubEspecialidad, $FechaInicio, $FechaFin, $IdEmpleado, $IdFarmacia, $IdEstablecimiento, $IdModalidad) {

    if ($IdEmpleado != '0') {
        $comp = "and sec_historial_clinico.IdEmpleado='$IdEmpleado'";
    } else {
        $comp = "";
    }
    if ($grupoTerapeutico != '0') {
        $comp3 = "and mnt_grupoterapeutico.IdTerapeutico='$grupoTerapeutico'";
    } else {
        $comp3 = "";
    }
    if ($IdFarmacia != '0') {
...
function QueryExterna($IdTerapeutico, $IdMedicina, $IdSubEspecialidad, $FechaInicio, $FechaFin, $IdEmpleado, $IdFarmacia, $IdEstablecimiento, $IdModalidad) {
...
function ObtenerRecetasSatisfechas($IdReceta, $IdMedicina, $FechaInicio, $FechaFin, $IdSubEspecialidad, $Bandera, $IdMedico, $IdFarmacia,$IdEstablecimiento,$IdModalidad) {
    ...
    if ($IdMedico != '0') {
        $comp3 = "and sec_historial_clinico.IdEmpleado='$IdMedico'";
    } else {
        $comp3 = "";
    }
...
function SumatoriaMedicamento($IdMedicina, $IdSubEspecialidad, $FechaInicio, $FechaFin, $IdMedico, $IdFarmacia, $IdEstablecimiento, $IdModalidad) {
