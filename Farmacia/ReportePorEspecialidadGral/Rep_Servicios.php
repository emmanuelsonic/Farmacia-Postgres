...
//******Generacion del combo principal
        ...
        <?php head(); ?>
                ...
                <title>...:::Reporte por Especialidad Con. Ext. :::...</title>
        ...
        <?php Menu(); ?>
                ...
                <form action="Reporte_Servicios.php" method="post" id="formulario" name="formulario">
                    <table width="816" border="0">
                        <tr class="MYTABLE">
                            <td colspan="5" align="center"><strong>CONSUMO DE MEDICAMENTOS POR ESPECIALIDAD </strong></td>
                        </tr>
                        ...
                        <tr>
                            <td width="280" class="FONDO"><strong>Especialidad: </strong></td>
