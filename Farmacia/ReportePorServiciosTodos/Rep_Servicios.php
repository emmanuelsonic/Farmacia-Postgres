...
//******Generacion del combo principal
        ...
        function generaSelectFarmacias($IdEstablecimiento,$IdModalidad) {
            conexion::conectar();
        ...
        <?php Menu(); ?>
                ...
                <form action="Reporte_Servicios.php" method="post" id="formulario" name="formulario">
                    ...
                    <table width="816" border="0">
                        <tr class="MYTABLE">
                            <td colspan="5" align="center"><strong>CONSUMO DE MEDICAMENTOS GENERAL DE SERVICIOS Y CONSULTAS</strong></td>
                        </tr>
                        <tr><td colspan="5" class="FONDO"><br></td></tr>
                        <tr><td class="FONDO"><strong>Farmacia:</strong></td><td colspan="4" class="FONDO"><?php generaSelectFarmacias($IdEstablecimiento,$IdModalidad); ?></td></tr>
                        <tr>
