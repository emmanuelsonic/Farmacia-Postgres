...
if (!isset($_SESSION["nivel"])) {
    ...
    if ($_SESSION["Datos"] != 1) {
        ...
        function ComboGrupoTerapeutico() {
            ...
            $combo = "<select id='IdTerapeutico' name='IdTerapeutico' onchange='CargarMedicina(this.value)'>
	  ...
	  <option value='0'>[GENERAL...]</option>";
        ...
        function ComboMedicina($IdEstablecimiento,$IdModalidad) {
            $combo = "<select id='IdMedicina' name='IdMedicina'><option value='0'>[GENERAL...]</option></select>";
            return($combo);
        }
        ?>
        <html>
        ...
        <?php head(); ?>
                ...
                <title>Bitacoras de Despachos</title>
        ...
        <?php Menu(); ?>
                ...
                <table width="950" border="1">
                    ...
                    <tr class="FONDO2">
                        ...
                        <td>&nbsp;<?php echo ComboFarmacia($IdEstablecimiento,$IdModalidad); ?></td>
                    </tr>
                    <tr class="FONDO2">
                    ...
                    <tr class="FONDO2">
                        ...
                        <td>&nbsp;<span id="ComboMedicina"><?php echo ComboMedicina($IdEstablecimiento,$IdModalidad); ?></span></td>
                    </tr>
