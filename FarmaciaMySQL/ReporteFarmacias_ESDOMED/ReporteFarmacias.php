...
$reporte='<table width="990" border="1">
  <tr class="MYTABLE">
    <td colspan="5" align="center"><strong>CONSUMO DE MEDICAMENTOS </strong></td></tr>
	
  <tr class="MYTABLE">
    <td colspan="5" align="center" style="vertical-align:middle;"><strong><h2>'.$NombreFarmacia.'</h2></strong></td>
  </tr>
    <tr class="MYTABLE">
    <td colspan="5" align="center" style="vertical-align:middle;"><strong>Periodo: '.$F1[2]."-".$F1[1]."-".$F1[0].' al '.$F2[2]."-".$F2[1]."-".$F2[0].'</strong></td></tr>';
  //<!--  INICIO DE REPORTE  -->
  ...
  $reporte.='<tr class="MYTABLE">
	<td colspan="5" align="center" style="background:#999999;"><strong>'.$GrupoTerapeutico.'</strong></td>
  </tr>
  	 <tr class="MYTABLE">
