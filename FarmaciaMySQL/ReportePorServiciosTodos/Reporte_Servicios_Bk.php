...
while($rowServicios=mysql_fetch_array($respServicios)){
	...
	$NombreSubEspecialidad=$rowServicios[1];
		$SubTotalServicio=0;
			...
			<tr class="FONDO2">
				...
				<strong><h2>'.$NombreSubEspecialidad.'</h2></strong>
				</td>
			</tr>';
    ...
    $reporte.='<tr class="FONDO2" style="background:#CCCCCC;">
	  ...
	  <td align="right">&nbsp;</td>
	  <td align="right">&nbsp;</td>
      <td align="right"><strong>'.number_format($SubTotalServicio,2,'.',',').'</strong></td>
    </tr>';
