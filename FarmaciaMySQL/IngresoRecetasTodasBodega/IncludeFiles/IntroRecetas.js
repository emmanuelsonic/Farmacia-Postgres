...
ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?Bandera=16&IdMedicina="+IdMedicina+"&IdArea="+IdArea+"&Fecha="+Fecha,true);
		ajax.send(null);
		return false;
...
ajax.open("GET","IncludeFiles/IntroduccionRecetasProceso.php?IdReceta="+IdReceta+"&Cantidad="+Cantidad+"&IdMedicina="+IdMedicina+
                "&Dosis="+Dosis+"&Bandera="+Bandera+"&IdHistorialClinico="+IdHistorialClinico+"&IdMedico="+IdMedico+"&IdArea="+IdArea+
                "&Satisfecha="+Satisfecha+"&Fecha="+Fecha,true);
		ajax.send(null);
		return false;
