...
// 
                ...
                $tabla = $tabla . '<tr class="FONDO"><td align="center"><a style="color:red;" onclick="">' . $CantidadIntro . '</a></td>
                                                    <td align="center">' . $row["Nombre"] . "<br>" . $row["Concentracion"] . ' - ' . htmlentities($row["FormaFarmaceutica"] . ' - ' . $row["Presentacion"]) . '</td>
                                                    <td align="center"><a style="color:blue;" onclick="javascript:VentanaBusqueda4(\'ModificaDosis.php?IdMedicinaRecetada=' . $row["IdMedicinaRecetada"] . '\')">' . $row["Dosis"] . '</a></td>
                                                    <td align="center">' . $check . '</td>
                                                    <td align="center"><input type="button" id="BorrarMedicamento" name="BorrarMedicamento" value="Eliminar Medicamento" onclick="javascript:EliminaMedicina(' . $row["IdMedicinaRecetada"] . ')"></td>
		</tr>';
            }//while resp
            $tabla = $tabla . "</table>";
...
//*************************************************/
		...
		<td width="275" align="center"><strong>Eliminar</strong></td>
                ...
                do {
                    ...
                    if ($respDivisor = mysql_fetch_array($proceso->ValorDivisor($row["IdMedicina"], $IdEstablecimiento, $IdModalidad)) and $_SESSION["TipoFarmacia"]) {
                        $Divisor = $respDivisor[0];
...
//REPETITIVAS
        ...
        case 13:
            ...
            $query = "select mssxe.IdSubServicioxEstablecimiento,NombreSubServicio, msxe.IdServicio  as Ubicacion
        ...
        case 14:
            ...
            if (isset($_GET["IdArea"])) {
                ...
                if ($IdReceta == '' or $IdReceta == NULL) {
                    ...
                    $proceso->ActualizarArea($IdArea, $IdReceta, $IdFarmacia,$IdEstablecimiento,$IdModalidad);
                }
